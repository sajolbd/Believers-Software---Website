...
export default function Industries() {
  ...
  return (
    <section className="py-12 bg-gradient-to-b from-slate-50/80 via-white to-slate-50/80 border-t border-slate-100 relative z-10 overflow-hidden" id="industries">
